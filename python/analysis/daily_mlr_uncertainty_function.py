...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 22 17:56:13 2020
...
def daily_mlr_uncertainty(stdev_number,location):
    ...
    if stdev_number == 1 and sensor['Location'].str.contains('Audubon').any():
        ...
        sigma_i_Augusta = 0.96
        slope_sigma_Augusta = 2.9
        sigma_i_BAM = 1.74
     
    elif stdev_number == 2 and sensor['Location'].str.contains('Audubon').any():
        sigma_i_summer = 1.56
        slope_sigma_summer = 1.4
        sigma_i_Augusta = 1.91
        slope_sigma_Augusta = 5.8
        sigma_i_BAM = 3.48
